const {getAllTopics, getApi, getArticleId, getAllArticles, getAllArticlesComments, getPostComment, patchArticle, deleteComment, getAllUsers, getUsername, patchComments} = require('./app.controllers/app.controller')
